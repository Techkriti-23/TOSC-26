        ...
        <div className="mx-auto max-w-xl pt-4">
          <form onSubmit={handleSearch} className="flex gap-2">
            <Input
              ...
              className="h-13 border-white/20 bg-white/10 px-5 text-sm text-white placeholder:text-white/40 backdrop-blur-md focus:border-white focus:bg-white/15"
            />
            <Button
              type="submit"
              className="h-13 bg-white px-6 font-semibold text-black hover:bg-white/90"
            >
          ...
          {searchedRecord ? (
            <div className="border border-white/20 bg-white/90 p-8 text-black shadow-2xl backdrop-blur-xl md:p-12 space-y-8">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b border-black/10 pb-6">
                <div>
                  <span className="bg-emerald-600 px-3 py-1 text-xs font-bold text-white uppercase tracking-wider">
                ...
                <div className="flex items-center gap-3">
                  <div className="bg-black/5 p-4 text-center min-w-28">
                  ...
                  <div className="bg-black text-white p-4 text-center min-w-28">
                  ...
                  <div className="bg-black/5 p-4 text-center min-w-28 hidden sm:block">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  {searchedRecord.subjectBreakdown.map((sub: any, idx: number) => (
                    <div
                      key={idx}
                      className="border border-black/10 bg-white p-5 shadow-sm space-y-2"
                    >
            ...
            <div className="border border-white/20 bg-white/10 p-12 text-center text-white backdrop-blur-xl space-y-3">
